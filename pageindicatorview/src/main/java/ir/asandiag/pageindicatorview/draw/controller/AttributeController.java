...
import ir.asandiag.pageindicatorview.R;
import ir.asandiag.pageindicatorview.animation.type.AnimationType;
import ir.asandiag.pageindicatorview.animation.type.BaseAnimation;
...
import ir.asandiag.pageindicatorview.draw.data.RtlMode;
...
public class AttributeController {
    ...
    private void initSizeAttribute(@NonNull TypedArray typedArray) {
        ...
        int stroke = (int) typedArray.getDimension(R.styleable.PageIndicatorView_piv_strokeWidth, DensityUtils.dpToPx(
                FillAnimation.DEFAULT_STROKE_DP));
        if (stroke > radius) {
            stroke = radius;
        }
