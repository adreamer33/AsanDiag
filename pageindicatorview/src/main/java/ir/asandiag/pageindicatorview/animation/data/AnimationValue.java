...
import ir.asandiag.pageindicatorview.animation.data.type.ColorAnimationValue;
import ir.asandiag.pageindicatorview.animation.data.type.DropAnimationValue;
import ir.asandiag.pageindicatorview.animation.data.type.FillAnimationValue;
import ir.asandiag.pageindicatorview.animation.data.type.ScaleAnimationValue;
import ir.asandiag.pageindicatorview.animation.data.type.SwapAnimationValue;
import ir.asandiag.pageindicatorview.animation.data.type.ThinWormAnimationValue;
import ir.asandiag.pageindicatorview.animation.data.type.WormAnimationValue;
