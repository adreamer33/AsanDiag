...
import ir.asandiag.pageindicatorview.draw.data.PositionSavedState;
...
import ir.asandiag.pageindicatorview.utils.IdUtils;
...
//    }
    ...
    private void init1(@Nullable AttributeSet attrs) {
        setupId();
