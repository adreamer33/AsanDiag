 ...
 */
public class NeumorphImageView extends AppCompatImageView {
    ...
    private void init(AttributeSet attrs, int defStyle, int defStyleRes) {
        ...
        shadowColorLight = a.getColor(R.styleable.NeumorphImageView_neumorph_shadowColorLight,
                ContextCompat.getColor(getContext(), R.color.design_dark_default_color_shadow_light));

        shadowColorDark = a.getColor(R.styleable.NeumorphImageView_neumorph_shadowColorDark,
