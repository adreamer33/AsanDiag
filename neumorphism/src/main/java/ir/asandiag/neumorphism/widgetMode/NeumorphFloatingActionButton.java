 ...
 */
public class NeumorphFloatingActionButton extends AppCompatImageButton {
    ...
    public NeumorphFloatingActionButton(@NonNull Context context) {
        super(context);
        init(null, 0, 0);
    }

    public NeumorphFloatingActionButton(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0, 0);
    }

    public NeumorphFloatingActionButton(@NonNull Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs, defStyle, 0);
    }

    public NeumorphFloatingActionButton(@NonNull Context context, AttributeSet attrs, int defStyle, int defStyleRes) {
        super(context, attrs, defStyle);
    ...
    private void init(AttributeSet attrs, int defStyle, int defStyleRes) {
        ...
        shadowColorLight = a.getColor(R.styleable.NeumorphFloatingActionButton_neumorph_shadowColorLight,
                ContextCompat.getColor(getContext(), R.color.design_dark_default_color_shadow_light));

        shadowColorDark = a.getColor(R.styleable.NeumorphFloatingActionButton_neumorph_shadowColorDark,
