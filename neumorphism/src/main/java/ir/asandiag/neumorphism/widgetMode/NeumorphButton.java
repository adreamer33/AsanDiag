...
public class NeumorphButton extends AppCompatButton {
    ...
    public NeumorphButton(@NonNull Context context) {
        super(context);
        init(null, 0, 0);
    }

    public NeumorphButton(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0, 0);
    }

    public NeumorphButton(@NonNull Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs, defStyle, 0);
    }

    public NeumorphButton(@NonNull Context context, AttributeSet attrs, int defStyle, int defStyleRes) {
        super(context, attrs, defStyle);
    ...
    private void init(AttributeSet attrs, int defStyle, int defStyleRes) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.NeumorphButton, defStyle, 0);
        ...
        shadowColorLight=a.getColor(R.styleable.NeumorphButton_neumorph_shadowColorLight,
                ContextCompat.getColor(getContext(), R.color.design_dark_default_color_shadow_light));

        shadowColorDark=a.getColor(R.styleable.NeumorphButton_neumorph_shadowColorDark,
...
//        ColorStateList ss = ColorStateList.valueOf();
