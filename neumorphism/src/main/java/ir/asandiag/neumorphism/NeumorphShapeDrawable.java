package ir.asandiag.neumorphism;
...
import ir.asandiag.neumorphism.internal.blur.BlurProvider;
import ir.asandiag.neumorphism.internal.shape.BasinShape;
import ir.asandiag.neumorphism.internal.shape.FlatShape;
import ir.asandiag.neumorphism.internal.shape.PressedShape;
import ir.asandiag.neumorphism.internal.shape.Shape;
import ir.asandiag.neumorphism.model.CornerFamily;
import ir.asandiag.neumorphism.model.NeumorphShapeAppearanceModel;
import ir.asandiag.neumorphism.model.ShapeType;
...
public class NeumorphShapeDrawable extends Drawable {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.drawCircle(50, 50, 200, fillPaint);
    }
    ...
    private void calculateOutlinePath(RectF bounds, Path path) {
        ...
        float left = drawableState != null ? (float) drawableState.padding.left : 0f;
        float top = drawableState != null ? (float) drawableState.padding.top : 0f;
