package ir.asandiag.neumorphism.shapeMode.neu;
...
public class NeumorphismShape extends ShapeOfView {
...
//    public int background_color = Color.parseColor("#E0E5Ec"); // move upper place
    ...
    public NeumorphismShape(@NonNull Context context) {
        super(context);
        init(context);
    }

    public NeumorphismShape(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public NeumorphismShape(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        gyroscopeSensor();
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (style == drop_shadow) {
            ...
            shadowPaint.setColor(ColorUtils.blendARGB(dark_color, Color.BLACK, 0.10f));

//            lightPaint.setMaskFilter(new BlurMaskFilter(5, BlurMaskFilter.Blur.NORMAL));
//            lightPaint.setColor(ColorUtils.blendARGB(light_color, Color.WHITE, 0.9f));
